...
print("Saving sensors simulation output to:", "simulation.txt")
simulation_out = open("node6_leds.txt", "w")
out = open("simulation.txt", "w")
# out = sys.stdout
...
t.addChannel("node6_leds", simulation_out)
